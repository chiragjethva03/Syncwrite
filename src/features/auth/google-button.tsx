...
/** Google's multi-color "G" mark (brand asset, inlined as SVG). */
...
/**
 * "Continue with Google" button + divider, shared by the login and register
 * screens. Delegates the whole OAuth handshake to Auth.js; on success the user
